...
- **Mini-date conversation flow**: A stateful, multi-turn conversation where each agent message is generated by the LLM in response to what the user actually said — not canned responses.
